...
The machine-readable [snapshot](deployments/bsc-mainnet.json) and SDK constants describe the September 13, 2026 factory text update and deferred-mining release, retaining paired-asset creator revenue and holder dividends.

| Setting | Current value |
| --- | --- |
| Factory proxy | `0x0abc6174ee9f9600243D14F83E215993b8BbABEb` |
| Factory implementation | `0x576c73bFb8Fede5eFf8814F50a00f7cb5D5bc77A` |
...
The factory text upgrade removes the 64-byte name and 12-byte symbol caps from the current template creation paths. Nonempty Unicode text is preserved, including Chinese and compound emoji. Upload request size and transaction gas limits still apply. Existing tokens retain their original names and symbols. See the [upgrade receipt](deployments/token-text.json).
